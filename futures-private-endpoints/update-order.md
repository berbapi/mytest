---
description: Update an existing futures order on PointPay Exchange.
---
...
| `qty`          | NUMERIC | Updated order quantity                                                               | `0.02`                               |
| `price`        | NUMERIC | Updated order price                                                                  | `65000`                              |
...
```hurl
curl -X POST "https://api.pointpay.io/fapi/v1/private/trade/update-order" \
